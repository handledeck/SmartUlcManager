    ...
    public void RunService(CancellationToken stoppingToken) {
      try
      {
        ...
        if (ll != null)
        {
          ...
          UlcSrvLog.Logger.Info("Успешно опрошено по устройствам: {0}", Worker.__cout_ulc_request);
        }
        ...
        if (meterValues != null)
        {
          ...
          UlcSrvLog.Logger.Info("Успешно опрошено по счетчикам: {0}", Worker.__cout_ulc_meters);
        }
        ...
        if (lst_rs != null)
        {
          ...
          UlcSrvLog.Logger.Info("Успешно опрошено по RS-485: {0}", Worker.__cout_ulc_rs485);
        }
            ...
            Task tsk = new Task(() =>
            {
              ...
              try
              {
                ...
                if (result)
                {
                  ...
                  Interlocked.Increment(ref Worker.__cout_ulc_request);
                }
              ...
              try
              {
                ...
                if (result)
                {
                  ...
                  if (item.UlcCnfg!=null) {
                    ...
                    {
                      item.is_true = true;
                      Interlocked.Increment(ref Worker.__cout_ulc_rs485);
                    }
                  }
                }
                //Interlocked.Increment(ref Worker.__cout_request);
