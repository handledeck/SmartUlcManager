          ...
          foreach (var item in cdata)
          {
            ...
            if (pdata.Length > 1)
            {
              ...
              if (pdata[0] == "APN")
                ...
                this.DEBOUNCE = int.Parse(pdata[1]);
                ...
                this.AIN = int.Parse(pdata[1]);
              else if (pdata[0] == "DIN")
                this.DIN = int.Parse(pdata[1]);
              else if (pdata[0] == "DOUT")
                this.DOUT = int.Parse(pdata[1]);
              else if (pdata[0] == "DOOR")
                this.DOOR = int.Parse(pdata[1]);
                ...
                this.CDIN = int.Parse(pdata[1]);
              else if (pdata[0] == "CDOUT")
                this.CDOUT = int.Parse(pdata[1]);
                ...
                this.SIGNAL = int.Parse(pdata[1]);
              else if (pdata[0] == "DBZ")
                this.DBZ = int.Parse(pdata[1]);
                ...
                this.FMW = (uint)long.Parse(pdata[1]);
              else if (pdata[0] == "TMSET")
              {
                ...
                this.TRAFC = (uint)long.Parse(pdata[1]);
            }
          }
          readed = true;
        }
